# [Flask Black Dashboard](https://appseed.us/admin-dashboards/flask-dashboard-black-pro)

[Admin dashboard](https://appseed.us/admin-dashboards) generated by AppSeed in **Flask** Framework on top of **[Black Dashboard](https://appseed.us/black-dashboard)** design (free version) from Creative-Tim. The product comes with basic modules, database (SQLite and PostgreSQL) and deployment scripts for Docker, HEROKU and Gunicorn/Nginx stack. The permissive (MIT) License allows the usage for unlimited hobby & commercial projects. 
...
---
[Flask Black Dashboard](https://appseed.us/admin-dashboards/flask-dashboard-black-pro) - Provided by **AppSeed** [Web App Generator](https://appseed.us/app-generator).
